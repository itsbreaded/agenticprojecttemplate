...
verification gap for load-bearing behavior. Important findings should be fixed
before execution when practical; editorial findings may be fixed while
...
the plan to `Plan Status: review`; do not approve a plan changed only by
